...
class TradingCertificateDetailScreen extends StatefulWidget {
  const TradingCertificateDetailScreen({super.key});

  @override
  State<TradingCertificateDetailScreen> createState() =>
      _TradingCertificateDetailScreenState();
}

class _TradingCertificateDetailScreenState
    extends State<TradingCertificateDetailScreen> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // header(context),
          TradingCertificateDetailsheet(size),
        ],
      ),
    );
  }
  ...
  TradingCertificateDetailsheet(Size size) {
