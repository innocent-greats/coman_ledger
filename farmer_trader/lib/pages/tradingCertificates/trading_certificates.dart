...
class TradingCertificatesScreen extends StatefulWidget {
  const TradingCertificatesScreen({super.key});

  @override
  State<TradingCertificatesScreen> createState() =>
      _TradingCertificatesScreenState();
}

class _TradingCertificatesScreenState extends State<TradingCertificatesScreen> {
  final ridesList = [
    {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return GestureDetector(
          onTap: () {
            Navigator.pushNamed(context, '/tradingCertificateDetail');
          },
          child: Container(
